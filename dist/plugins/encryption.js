define(["exports", "vue", "./encryption/masterPasswordRequest.vue", "./encryption/forgotPrompt.vue", "./store/auth"], function (_exports, _vue, _masterPasswordRequest, _forgotPrompt, authModule) {
  "use strict";
  ...
  _masterPasswordRequest = _interopRequireDefault(_masterPasswordRequest);
  _forgotPrompt = _interopRequireDefault(_forgotPrompt);
  authModule = _interopRequireWildcard(authModule);
